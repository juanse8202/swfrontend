...
export default function RelationEdge({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, data, markerEnd: fallbackMarkerEnd, style }) {
  ...
  const apply = () => {
    useDiagramStore.getState().updateRelation(id, {
      ...
      multiplicidadDestino: targetMultiplicity || 'N',
      umlLabel,
    });
    setOpen(false);
  };
